...
public class SettingsManager {
    ...
    // Returns the absolute path of the application io on the local drive
    ...
    public static String toString2() {
        return  "server path:           " + getServerPath() + System.getProperty("line.separator") +
                ...
                "server app io path  " + getServerAppFilesPath() + System.getProperty("line.separator") +
                ...
                "local app io path:  " + System.getProperty("line.separator");
    }
