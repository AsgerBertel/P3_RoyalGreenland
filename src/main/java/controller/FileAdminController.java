...
import gui.custom_node.AdminFilesContextMenu;
import gui.custom_node.ChangeBox;
import log.LogEvent;
...
public class FileAdminController implements TabController {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fileTreeView.setCellFactory(new DragAndDropTreeCellFactory(this));
        startWatchThread();
    }
    ...
    private void onTreeItemSelected(TreeItem<AbstractFile> oldValue, TreeItem<AbstractFile> newValue) {
    ...
    private Optional<String> createFolderPopUP() {
    ...
    private Optional<String> renameFilePopUP() {
        TextInputDialog txtInputDia = new TextInputDialog();
    ...
    /**
     * Watches io for changes, Listener only reacts on changes and calls update() in case invoked.
    ...
    public void startWatchThread() {
        ...
        observer.addListener(new FileAlterationListener() {
            ...
            public void onFileChange(File file) {
                // Don't register changes to temporary word io
