...
class FileManagerTest extends FileTester {
    ...
    private final Path docPath = Paths.get("03_URENSET STENBIDERROGN/GMP 03 GR_02.pdf");
    private Document doc;
    private final Path doc2Path = Paths.get("02_VINTERTØRRET FISK/HA 02 GR_02  HACCP plan for indfrysning af fisk.doc");
    private Document doc2;
    private final Path parentFolderPath = Paths.get("03_URENSET STENBIDERROGN");
    ...
    void restoreFile() throws IOException {
        ...
        //asserts that doc is in archive, and not ind main io
        ...
        //asserts that doc is not in archive io, and it is in main io
        assertFalse(fileManager.findFile(doc.getOSPath(), fileManager.getArchiveFiles()).isPresent());
